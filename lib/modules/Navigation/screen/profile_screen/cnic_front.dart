...
class CNIC_Front_Screen extends StatefulWidget {
  const CNIC_Front_Screen({super.key});

  @override
  State<CNIC_Front_Screen> createState() => _CNIC_Front_ScreenState();
}

class _CNIC_Front_ScreenState extends State<CNIC_Front_Screen> {
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
            const Text('Take a Photo of your CNIC Front Side').text.size(30).bold.make().py24(),
            const Text('Take a picture of the front side of your national ID card'
            ...
            const Text('What is this?').text.color(Colors.blue).size(18).make().px12()
             ...
             image.imagePath.isEmpty ? Container(
              ...
              child: Image.asset('assets/cnicfront.jpg',fit: BoxFit.cover,),
